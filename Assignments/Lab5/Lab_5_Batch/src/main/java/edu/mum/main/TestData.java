...
//------------------------------------------------------
		...
		//------------------------------------------------------
		User userJagaa = new User();
		userJagaa.setFirstName("Jagaa");
		userJagaa.setLastName("Gan");
		userJagaa.setEmail("jagaa@Gan.com");


		userService.save(userJagaa);

		userJagaa.getBoughtItems().add(itemJewelry);
		userJagaa.getBoughtItems().add(itemRound);
		userService.update(userJagaa);
